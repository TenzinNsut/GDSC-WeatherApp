...
function MainCard(props) {
    return (
      <div className="text-white md:min-w-[500px] h-auto mt-5  md:h-[auto] p-5 rounded-xl shadow-2xl bg-[rgba(255,255,255,0.1)]  backdrop:blur-[10px] border-2 border-[rgba(255,255,255,0.25)] ">
